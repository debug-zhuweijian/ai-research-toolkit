...
- `tags` must follow vault tag rules: type tag (`paper`) + 1-2 domain tags (e.g. `BCI/语音合成`) + optional method tags (e.g. `方法/CTC`). See CLAUDE.md "Tag 打标规则" for full enumeration.
