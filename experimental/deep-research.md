...
Deploy this agent whenever the active workflow needs authoritative information from outside the repository.
...
Escalate back to the calling workflow if authoritative sources are unavailable or if further clarification from the user is required.
